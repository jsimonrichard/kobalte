...
// or
import { Root, List, ... } from "@trellis-app/kobalte-core/tabs";
// or (deprecated)
import { Tabs } from "@trellis-app/kobalte-core";
```
...
`Tabs` is equivalent to the `Root` import from `@trellis-app/kobalte-core/tabs` (and deprecated `Tabs.Root`).
