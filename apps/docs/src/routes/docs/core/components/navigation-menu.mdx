...
```ts
import { NavigationMenu } from "@trellis-app/kobalte-core/navigation-menu";
// or
import { Root, Menu, ... } from "@trellis-app/kobalte-core/navigation-menu";
```
...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="index.tsx">
    ```tsx
    import { NavigationMenu, Orientation } from "@trellis-app/kobalte-core/navigation-menu";
...
`NavigationMenu` is equivalent to the `Root` import from `@trellis-app/kobalte-core/NavigationMenu`.
