...
// or
import { Root, Trigger, ... } from "@trellis-app/kobalte-core/dropdown-menu";
// or (deprecated)
import { DropdownMenu } from "@trellis-app/kobalte-core";
```
...
`DropdownMenu` is equivalent to the `Root` import from `@trellis-app/kobalte-core/dropdown-menu` (and deprecated `DropdownMenu.Root`).
