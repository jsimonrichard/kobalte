...
// or
import { Root, Label, ... } from "@trellis-app/kobalte-core/combobox";
// or (deprecated)
import { Combobox } from "@trellis-app/kobalte-core";
```
...
`Combobox` is equivalent to the `Root` import from `@trellis-app/kobalte-core/combobox` (and deprecated `Combobox.Root`).
