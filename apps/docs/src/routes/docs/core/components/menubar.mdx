...
// or
import { Root, Menu, ... } from "@trellis-app/kobalte-core/menubar";
// or (deprecated)
import { Menubar } from "@trellis-app/kobalte-core";
```
...
`Menubar` is equivalent to the `Root` import from `@trellis-app/kobalte-core/menubar` (and deprecated `Menubar.Root`).
