...
// or
import { Root, Label, ... } from "@trellis-app/kobalte-core/radio-group";
// or (deprecated)
import { RadioGroup } from "@trellis-app/kobalte-core";
```
...
`RadioGroup` is equivalent to the `Root` import from `@trellis-app/kobalte-core/radio-group` (and deprecated `RadioGroup.Root`).
