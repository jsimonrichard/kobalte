...
// or
import { Root, Trigger, ... } from "@trellis-app/kobalte-core/collapsible";
// or (deprecated)
import { Collapsible } from "@trellis-app/kobalte-core";
```
...
`Collapsible` is equivalent to the `Root` import from `@trellis-app/kobalte-core/collapsible` (and deprecated `Collapsible.Root`).
