...
```tsx
import { I18nProvider, useLocale } from "@trellis-app/kobalte-core/i18n";
// or (deprecated)
import { I18nProvider, useLocale } from "@trellis-app/kobalte-core";
```
...
```tsx
import { I18nProvider } from "@trellis-app/kobalte-core/i18n";
...
```tsx
import { useLocale } from "@trellis-app/kobalte-core/i18n";
