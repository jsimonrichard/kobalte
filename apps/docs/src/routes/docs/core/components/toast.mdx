...
// or
import { Root, toaster, ... } from "@trellis-app/kobalte-core/toast";
// or (deprecated)
import { Toast, toaster } from "@trellis-app/kobalte-core";
```
...
`Toast` is equivalent to the `Root` import from `@trellis-app/kobalte-core/toast` (and deprecated `Toast.Root`).
