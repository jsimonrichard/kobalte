...
// or
import { Root, Item, ... } from "@trellis-app/kobalte-core/accordion";
// or (deprecated)
import { Accordion } from "@trellis-app/kobalte-core";
```
...
`Accordion` is equivalent to the `Root` import from `@trellis-app/kobalte-core/accordion` (and deprecated `Accordion.Root`).
