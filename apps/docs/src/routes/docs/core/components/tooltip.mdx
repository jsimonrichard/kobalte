...
// or
import { Root, Trigger, ... } from "@trellis-app/kobalte-core/tooltip";
// or (deprecated)
import { Tooltip } from "@trellis-app/kobalte-core";
```
...
`Tooltip` is equivalent to the `Root` import from `@trellis-app/kobalte-core/tooltip` (and deprecated `Tooltip.Root`).
