...
// or
import { Root, Label, ... } from "@trellis-app/kobalte-core/progress";
// or (deprecated)
import { Progress } from "@trellis-app/kobalte-core";
```
...
`Progress` is equivalent to the `Root` import from `@trellis-app/kobalte-core/progress` (and deprecated `Progress.Root`).
