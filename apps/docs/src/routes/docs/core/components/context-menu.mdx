...
// or
import { Root, Trigger, ... } from "@trellis-app/kobalte-core/context-menu";
// or (deprecated)
import { ContextMenu } from "@trellis-app/kobalte-core";
```
...
`ContextMenu` is equivalent to the `Root` import from `@trellis-app/kobalte-core/context-menu` (and deprecated `ContextMenu.Root`).
