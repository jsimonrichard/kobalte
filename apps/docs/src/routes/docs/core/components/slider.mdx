...
// or
import { Root, Track, ... } from "@trellis-app/kobalte-core/slider";
// or (deprecated)
import { Slider } from "@trellis-app/kobalte-core";
```
...
`Slider` is equivalent to the `Root` import from `@trellis-app/kobalte-core/slider` (and deprecated `Slider.Root`).
