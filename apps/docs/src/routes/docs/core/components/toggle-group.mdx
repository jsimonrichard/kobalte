...
// or
import { Root, Item, ... } from "@trellis-app/kobalte-core/toggle-group";
// or (deprecated)
import { ToggleGroup } from "@trellis-app/kobalte-core";
```
...
<TabsSnippets>
	...
	<TabsSnippets.Content value="index.tsx">
		```tsx
		import {ToggleButton} from "@trellis-app/kobalte-core/toggle-group";
...
`ToggleGroup` is equivalent to the `Root` import from `@trellis-app/kobalte-core/toggle-group` (and deprecated `ToggleGroup.Root`).
