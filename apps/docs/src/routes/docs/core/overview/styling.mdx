...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="tsx">
    ...
    ```tsx
    import { Popover as KPopover } from "@trellis-app/kobalte-core";
    import "./style.css";
...
If you are using [TailwindCSS](https://tailwindcss.com/), you can use the `@trellis-app/kobalte-tailwindcss` plugin to target Kobalte's `data-*` attributes with modifiers like `ui-expanded:*`.
...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="npm">
    {/* <!-- prettier-ignore-start --> */}
    ```bash
    npm install @trellis-app/kobalte-tailwindcss
    ```
    {/* <!-- prettier-ignore-end --> */}
  </TabsSnippets.Content>
  <TabsSnippets.Content value="yarn">
    {/* <!-- prettier-ignore-start --> */}
    ```bash
    yarn add @trellis-app/kobalte-tailwindcss
    ```
    {/* <!-- prettier-ignore-end --> */}
  </TabsSnippets.Content>
  <TabsSnippets.Content value="pnpm">
    {/* <!-- prettier-ignore-start --> */}
    ```bash
    pnpm add @trellis-app/kobalte-tailwindcss
    ```
    {/* <!-- prettier-ignore-end --> */}
  </TabsSnippets.Content>
</TabsSnippets>
...
```tsx
import { Popover as KPopover } from "@trellis-app/kobalte-core/popover";
...
If you are using [Vanilla Extract](https://vanilla-extract.style/), you can use the `@trellis-app/kobalte-vanilla-extract` plugin to target Kobalte's `data-*` attributes.
...
<TabsSnippets>
  ...
  <TabsSnippets.Content value="npm">
    {/* <!-- prettier-ignore-start --> */}
    ```bash
    npm install @trellis-app/kobalte-vanilla-extract
    ```
    {/* <!-- prettier-ignore-end --> */}
  </TabsSnippets.Content>
  <TabsSnippets.Content value="yarn">
    {/* <!-- prettier-ignore-start --> */}
    ```bash
    yarn add @trellis-app/kobalte-vanilla-extract
    ```
    {/* <!-- prettier-ignore-end --> */}
  </TabsSnippets.Content>
  <TabsSnippets.Content value="pnpm">
    {/* <!-- prettier-ignore-start --> */}
    ```bash
    pnpm add @trellis-app/kobalte-vanilla-extract
    ```
    {/* <!-- prettier-ignore-end --> */}
  </TabsSnippets.Content>
</TabsSnippets>
