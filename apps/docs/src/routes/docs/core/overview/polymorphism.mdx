...
```tsx {6-9}
import { Tabs, TabsTriggerOptions, TabsTriggerRenderProps } from "@trellis-app/kobalte-core/tabs";
import { PolymorphicCallbackProps } from "@trellis-app/kobalte-core/polymorphic";
...
```tsx
import { Tabs, TabsTriggerProps } from "@trellis-app/kobalte-core/tabs";
import { PolymorphicProps } from "@trellis-app/kobalte-core/polymorphic";
...
tagname for other components, imported from `"@trellis-app/kobalte-utils"`.
...
`ElementOf<T>` is a helper from `"@trellis-app/kobalte-core/polymorphic"` that converts a tag name into its element
